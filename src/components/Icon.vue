...
// Monochrome line icons drawn on a 24x24 grid. They inherit the surrounding
// text colour via `currentColor`, so they pick up hover/active states for
// free and stay legible in both light and dark themes.
